...
export const aboutSections: Section[] = [
  { 
    ...
    level: 1, 
    content: [`Gym memberships are expensive. Gis and uniforms are expensive. Tournaments are expensive. And hopefully you haven't experienced this yet, but hospital visits are also expensive. While it's reasonable to attach costs to goods and services, I don't want access to educational and instructional material to be another financial barrier to our sport.`,
