...
export const neutralSections: Section[] = [
  { 
    title: "Neutral", 
    level: 1, 
    content: [`The “neutral” position is when both grapplers are on their feet and where an individual has the option to either attempt to take their opponent 
            ...
            is borrowed from American collegiate wrestling, where it distinguishes the standing position from the “top-bottom” position on the mat.`],
    ref: "aboutRef"
  }
];

export default neutralSections;